...
def main(**kwargs):
    ...
    if train_config.batching_strategy == "packing":
        concatedataset_path = os.path.join(train_config.concatedataset_dir, "{}-{}.npy".format(dataset_config.dataset, "train"))
        dataset_train = ConcatDataset(
            dataset_train, 
            chunk_size=train_config.context_length, 
            concatedataset_path=concatedataset_path,
            overwrite_concatedataset=train_config.overwrite_concatedataset
        )
    ...
    if train_config.run_validation:
        if train_config.batching_strategy == "packing":
            concatedataset_path = os.path.join(train_config.concatedataset_dir, "{}-{}.npy".format(dataset_config.dataset, "validation"))
